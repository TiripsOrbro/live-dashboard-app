...
const { normalizeStoreKey, isTestStore } = require('../../../stores/src/testStore');
...
const STORES_CONFIG_PATH = path.join(paths.dashboard.config, 'upselling-stores.json');
const LEGACY_CONFIG_PATH = path.join(paths.dashboard.config, 'upselling.json');
