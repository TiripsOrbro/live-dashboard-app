...
const CONVERT_TO_BOX_PATH = path.join(__dirname, '..', '..', 'vendors', '.ConvertToBox');
const CONVERT_TO_BOX_EXAMPLE = path.join(__dirname, '..', '..', 'vendors', 'examples', '.ConvertToBox.example');
